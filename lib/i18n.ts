...
export const translations: Record<Lang, Dictionary> = {
  cs: {
    ...
    gallery: {
      ...
      alts: [
        "Nápoj Miboo před neonovým nápisem I Love Prague",
        "Oreo mléčný čaj s tapiokou v ruce",
        "Bubble tea Miboo na Staroměstském náměstí",
      ],
    },
    hours: {
  ...
  en: {
    ...
    gallery: {
      ...
      alts: [
        "Miboo drink in front of the I Love Prague neon sign",
        "Oreo milk tea with tapioca in hand",
        "Miboo bubble tea at Old Town Square",
      ],
    },
    hours: {
